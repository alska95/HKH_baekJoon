...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int z = 0 ; z < testCase ; z++){
            ...
            ArrayList<ArrayList<com.company.Main.Log>> board = new ArrayList<>();
            ...
            int result = 0;
            Queue<com.company.Main.Log> bfsQueue = new LinkedList<>();
            for(int i = 0 ; i < board.get(1).size() ; i++){
                com.company.Main.Log target = board.get(1).get(i);
                target.flightCount++;
                target.visited[1] = 1;
...
//                System.out.println("target.cityCount = " + target.cityCount);
            ...
            while(!bfsQueue.isEmpty()){
                com.company.Main.Log cur = bfsQueue.poll();
                for(int i = 0 ; i < board.get(cur.next).size() ; i++){
                    com.company.Main.Log target = board.get(cur.next).get(i);
